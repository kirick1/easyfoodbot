...
exports.askQuestion = (conversation, question, askConfirmation = false, validator = exports.defaultTextValidator) => new Promise(resolve => conversation.ask(question, async (payload) => {
    ...
    if (validator(answer)) {
        ...
        const yes = await exports.askYesNo(conversation, `${answer}, is it correct?`);
        return resolve(yes ? answer : await exports.askQuestion(conversation, question, askConfirmation, validator));
    }
    else
